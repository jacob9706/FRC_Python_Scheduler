...
class PIDDiffrence(wpilib.PIDController):
	def __init__(self, Kp, Ki, Kd, source1, source2, period=0.05):
		super(PIDDiffrence, self).__init__(Kp, Ki, Kd, source1, None, period=0.05)
